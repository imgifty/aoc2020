...
#     ingoing = '''shiny gold bags contain 2 dark red bags.
...
# dark violet bags contain no other bags.'''
    ...
    ingoing = '''dull silver bags contain 2 striped magenta bags, 2 dark coral bags, 1 bright orange bag, 4 plaid blue bags.
